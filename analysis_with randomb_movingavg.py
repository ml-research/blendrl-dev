...
directory_path = "out_spaceinvaders/tensorboard/spaceinvaders_softmax_blender_logic_lr_0.00025_llr_0.00025_blr_0.00025_gamma_0.99_bentcoef_0.01_numenvs_50_steps_128__0"

def run_random_baseline(env_name="ALE/SpaceInvaders-v5", num_episodes=100):
    env = OCAtari(
        env_name=env_name,
        mode="ram",
        obs_mode="ori",
